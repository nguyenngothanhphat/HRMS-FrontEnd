export const OFFBOARDING = {
  ...
  MEETING_STATUS: {
    ...
    HR_PICK_DATE: 'HR_PICK_DATE',
    EMPLOYEE_ACCEPT_HR_DATE: 'EMPLOYEE_ACCEPT_HR_DATE',
    DONE: 'DONE',
  },
  UPDATE_ACTION: {
    MANAGER_RESCHEDULE: 'MANAGER_RESCHEDULE',
    EMPLOYEE_RESCHEDULE: 'EMPLOYEE_RESCHEDULE',
    HR_RESCHEDULE: 'HR_RESCHEDULE',
    EMPLOYEE_ACCEPT_HR_MEETING: 'EMPLOYEE_ACCEPT_HR_MEETING',
    ...
    ASSIGN_HR: 'ASSIGN_HR',
    ACCEPT_MANAGER_LWD: 'ACCEPT_MANAGER_LWD',
    REJECT_MANAGER_LWD: 'REJECT_MANAGER_LWD',
