...
export default class BreadcrumbView extends PureComponent {
  ...
  componentDidUpdate(preProps, prevState) {
    ...
    if (prevState.breadcrumbNameMap !== breadcrumbNameMap) {
      this.getBreadcrumbDom();
    }
    if (prePathname !== location.pathname || breadcrumb === null) {
      this.getBreadcrumbDom();
    }
  }
  ...
  static getDerivedStateFromProps(props, state) {
    if (props.breadcrumbNameMap !== state.breadcrumbNameMap) {
      return {
  ...
  conversionBreadcrumbList = () => {
    ...
    if (routerLocation && routerLocation.pathname && !breadcrumbNameMap.isEmpty) {
