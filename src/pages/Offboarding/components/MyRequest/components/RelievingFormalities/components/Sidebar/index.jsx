...
const array = [
  {
    ...
    decription: (
      <p>
        Make sure your report is done with his current project to have this discussion continued.
      </p>
    ),
  },
  {
      ...
      <div className={styles.Sidebar}>
        <div className={styles.boxRight}>
          ...
          <div className={styles.text_Body}>
            <p>Have you discussed your concerns with your Manager Sandeep</p>
          </div>
          <div className={styles.text_Schedule}>Schedule 1-on-1 Now!</div>
          <div className={styles.twoRight}>
            <p className={styles.text_twoRight}>Few other things to consider</p>
