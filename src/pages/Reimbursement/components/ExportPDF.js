...
const getPaymentOption = paymentOption => {
  switch (paymentOption) {
    case 'cash':
      return formatMessage({ id: 'bill.cash' });
    case 'credit card':
      return formatMessage({ id: 'bill.credit-card' });
    case 'company cc':
      return formatMessage({ id: 'bill.company-credit-card' });
    case 'company cash':
      return formatMessage({ id: 'bill.company-cash' });
    default:
      return '';
  }
};
