...
describe('Project management Automation', () => {
  ...
  const employee_email = 'khang.le@mailinator.com';
  ...
  it('Creating a project', () => {
    ...
    const fromDate = '05-21-2022';
    const toDate = '06-04-2023';
    ...
    cy.get('#myForm_engineeringOwner', { timeout: 3000 }).type('Kuntappa' + '{enter}', {
      force: true,
    });
    cy.get('#myForm_division', { timeout: 3000 }).type('Software Services' + '{enter}', {
      force: true,
    });
    cy.get('.ant-select-selection-overflow-item.ant-select-selection-overflow-item-suffix').type(
      'Design' + '{enter}' + 'Frontend' + '{enter}',
      { forcr: true },
    );
    ...
    cy.wait(3000);
    // cy.get('.anticon.anticon-close-circle').click({force:true}
    const Sdate = 'Apr 06, 2022';
    const Edate = 'Apr 07, 2023';
    ...
    cy.get('.ant-modal-close-x').click({ force: true });
    // filter
    const sfromdate = 'Apr 26, 2022';
    const stodate = 'Apr 27, 2022';
    const efromdate = 'May 03, 2022';
    const etodate = 'May 11, 2022';
    const rfromdate = 'May 13, 2022';
    const rtodate = 'May 16, 2022';
    cy.get('img[src="/static/filter.5d3ad138.svg"]').click({ force: true });
    cy.wait(3000);
    cy.get('#filter_designation').click({ force: true });
    cy.get('.ant-select-item-option-content').eq(0).click({ force: true });
    ...
    const endDate = '2022-07-22';
    const startDate1 = '2022-04-25';
    const endDate1 = '2022-07-25';
