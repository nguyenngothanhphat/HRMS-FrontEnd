...
describe('Dashboard Automation', () => {
  ...
  it('Log In HRMS', () => {
    ...
    // it('My Calender', () => {
    cy.get('.ant-tabs-tab-btn').eq(0).click({ force: true }).wait(2000);
    cy.get('img[src="/static/smallRightArrow.e2ea1246.svg"]').eq(0).click({ force: true });
    cy.wait(2000);
    ...
    cy.get('img[src="/static/smallRightArrow.e2ea1246.svg"]')
      ...
      .scrollIntoView(top)
      .wait(1500);
    cy.get('img[src="/static/smallLeftArrow.e194d918.svg"]').eq(0).click().wait(1500);
    cy.get('.viewAllMeetingBtn___1FKV8').click().wait(2000);
    cy.get('.ant-modal-close-x').click();
    // });

    // it('TimeSheet', () => {
    cy.get('.ant-picker-calendar.ant-picker-calendar-full.CustomCalendar___2J4ay')
      .scrollTo('bottom')
      .click()
      .wait(1500);
    cy.get('.ant-picker-calendar.ant-picker-calendar-full.CustomCalendar___2J4ay')
      .scrollTo('top')
      .click();
    cy.get('img[src="/static/smallRightArrow.e2ea1246.svg" ]').eq(1).click({ focus: true });
    cy.wait(2000);
    cy.get('img[src="/static/smallLeftArrow.e194d918.svg" ]').eq(1).click({ force: true });
    cy.wait(1500);
    ...
    cy.get('img[src="/static/open.ca1ae26b.svg"]').eq(0).click({ force: true }).wait(2000);
    cy.get('.ant-modal-close-x').click({ force: true }).wait(2000);
    ...
    cy.get('.ant-select-selector').eq(2).click({ force: true }).wait(2000);
    cy.get('.ant-select-item-option-content').eq(2).click({ force: true });
    cy.get('.ant-modal-close-x').click({ force: true });

    //my Task
    cy.get('.ant-tabs-tab-btn').eq(5).click({ force: true }).scrollIntoView(top).wait(1500);
    ...
    //my projects
    cy.get('.ant-tabs-tab-btn').eq(6).click({ force: true }).scrollIntoView(top).wait(1500);
    ...
    cy.get('.Resources___1O9wB').scrollTo('bottom').click({ force: true }).wait(2000);
    cy.get('.Resources___1O9wB').scrollTo('top').click({ force: true }).wait(2000);
    ...
    cy.get('.ant-col.ant-col-8.AppCard___3DaAf').eq(0).click({ force: true }).wait(2000);
    cy.go('back').wait(2000);
    cy.get('.ant-col.ant-col-8.AppCard___3DaAf').eq(1).click({ force: true }).wait(2000);
    cy.go('back').wait(2000);
    cy.get('.ant-col.ant-col-8.AppCard___3DaAf').eq(2).click({ force: true }).wait(2000);
    cy.go('back').wait(2000);
  });
});
