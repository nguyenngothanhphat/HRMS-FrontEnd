...
describe('Ticket Management', () => {
  ...
  it('My Tickets', () => {
    ...
    cy.get('.ant-input-affix-wrapper.ant-select-selection-search-input')
      ...
      .click({ force: true })
      .wait(2000);
    cy.get('.anticon.anticon-close-circle.ant-input-clear-icon').click({
      force: true,
    });
    ...
    cy.get('.anticon.anticon-close-circle')
      .eq(1)
      .click({ force: true })
      .wait(2000);
    ...
    cy.get('.ant-tabs-tab-btn').eq(3).click();
    cy.wait(3000);
    cy.get('.filterIcon___3zXzI').click({ force: true }).wait(2000);
    ...
    cy.get('.ant-tabs-tab-btn').eq(6).click();
    cy.wait(2000);
    cy.get('.filterIcon___3zXzI').click({ force: true });
    ...
    cy.get('.ant-select-selection-placeholder').eq(2).click({ force: true });
    cy.get(
      '.ant-select-item.ant-select-item-option.ant-select-item-option-active',
    )
      .eq(1)
