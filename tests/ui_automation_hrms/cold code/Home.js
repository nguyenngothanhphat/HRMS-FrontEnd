...
describe('HRMS URL', () => {
    ...
    it('Click The Birthday Poster', ()=> {
      ...
      cy.get('.slick-arrow.slick-prev').eq(1).click();
      cy.wait(1000);
      //cy.get('.iconCircle___3_3BW').eq(0).click();
      //cy.wait(2000);
    });
...
//        cy.wait(2000);
//        cy.get('.ant-btn.btnGroup___bFJJd.btnSubmit___3yMsI').click();
// });

it('My Team', ()=> {
  cy.contains('My Team (0)').click();
  cy.wait(2000);
  cy.contains('My Tickets (04)').click();
  cy.wait(2000);
  cy.contains('View').click();
  cy.wait(2000);
  cy.get('.ant-form-item-control-input-content').eq(0).type("sravan");
  cy.wait(2000);
  cy.get('.ant-modal-close-x').click();
  cy.wait(2000);
...
it('Quick Apps', ()=> {
  ...
  cy.get('.ant-modal-close-x').click();
  cy.wait(1000);
  // cy.get('.iconCircle___3_3BW').eq(3).click();
  // cy.wait(2000);
